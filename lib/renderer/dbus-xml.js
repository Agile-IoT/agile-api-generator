...
DbusXmlRenderer.prototype.getDBusType = function (type) {
  ...
  if(type.reference && this.definition.types[type.reference]) {
    console.warn(this.definition.types[type.reference]);
    return this.getDBusType(this.definition.types[type.reference]);
  }

  if(type.reference) {
    // if(this.definition.types[type.reference]) {
    //   typeName = this.definition.types[type.reference];
    //   console.warn(typeName);
    // }
    // else
      console.warn("TODO: handle object references");
  ...
  if(typeName === 'array') {
    // console.warn(type.fields.__arrayType);
